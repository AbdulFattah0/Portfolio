...
// Project filtering (Additional Projects grid only — Featured always shows)
const filterBtns = document.querySelectorAll(".filter-btn");
const projectItems = document.querySelectorAll(".compact-item");
...
function addAnimationClasses() {
  ...
  const heroElements = document.querySelectorAll(
    "#hero h1, #hero h2, #hero p, #hero .hero-buttons, #hero .social-icons",
  );
...
// ===== 6. Project Filtering =====
// Filter Additional Projects by category
